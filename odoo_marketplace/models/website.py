...
class Website(models.Model):
    ...
    mp_seller_new_status_msg = fields.Text(
        string="For New Status", default="از شما بخاطر ثبت‌نام در سایت ما سپاسگزاریم. برای بهره‌مندی از مزایای بازار ما، تمامی اطلاعات خود را تکمیل کرده و درخواست تایید ارسال کنید.", translate=True)
