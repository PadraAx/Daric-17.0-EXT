                ...
                self._cr.execute('''
                    INSERT INTO account_move_line (
                      ...
                      (SELECT name, %s,create_uid, create_date, write_uid, write_date,
                        ...
                        case
                            when account_move_line.credit != 0 and account_move_line.credit != ABS(account_move_line.amount_residual) then 
                                 account_move_line.credit - ABS(account_move_line.amount_residual)
                            else account_move_line.credit
                        end as credit,
                        case
                            when account_move_line.debit != 0 and account_move_line.amount_residual != account_move_line.debit then 
                                 account_move_line.debit - account_move_line.amount_residual
