...
class MailChimp(http.Controller):
    ...
    def mailchimp_api(self, token=False, **kwargs):
        ...
        if kwargs.get('data[merges][EMAIL]', False):
            ...
            contact_id = contact_obj.search(['|', ('email', '=', email_address), ('subscription_ids.mailchimp_id', '=', mailchimp_id)], limit=1)
            ...
            merge_field_dict = {}
            update_partner_required = account_id.auto_create_partner
            ...
            if kwargs.get('data[action]', '') != 'delete':
                ...
                if not contact_id:
                    if prepared_vals_for_create_partner and account_id.auto_create_partner:
