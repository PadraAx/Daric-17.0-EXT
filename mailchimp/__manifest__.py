{
    ...
    "version": "1.0",
    "category": "Marketing",
    'summary': 'Automate - Integrate & Manage MailChimp Operations from Odoo (Odoo MailChimp, MailChimp Odoo, Mailchimp Connector)',
    ...
    'images': ['static/description/mailchimp_odoo.jpg'],
