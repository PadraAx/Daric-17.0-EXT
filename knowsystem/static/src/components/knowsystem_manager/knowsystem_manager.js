...
import { KmsExportDataDialog } from "@knowsystem/views/dialogs/kms_export_dialog/kms_export_dialog";
const { Component, onWillStart, useState } = owl;

const componentModel = "knowsystem.article";


export class KnowSystemManager extends Component {
    static template = "knowsystem.KnowSystemManager";
    static props = {
    ...
    */
    async _onProceedExport() {
        ...
        this.dialogService.add(KmsExportDataDialog, dialogProps);
    }
    /*
