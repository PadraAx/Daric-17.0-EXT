/** @odoo-module alias=knowsystem.design_constants **/
// implemented based on mass_mailing/src/js/mass_mailing_design_constants

export const CSS_PREFIX = '.knowsystem_wrapper';
...
export const initializeTabCss = $editable => {
...
export default {
    ...
    splitCss, getFontName, normalizeFontFamily, initializeTabCss,
