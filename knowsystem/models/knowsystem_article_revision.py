...
class knowsystem_article_revision(models.Model):
    ...
    @api.depends("name", "author_id.name", "change_datetime")
    ...
    def _compute_display_name(self):
        ...
        for revision in self:
            revision.display_name = _("Revision of the article {} by {} on {}".format(
                revision.name, revision.author_id.name, revision.change_datetime,
            ))
