...
class knowsystem_tour_article(models.Model):
    ...
    article_id = fields.Many2one("knowsystem.article", string="Article", required=True, ondelete="cascade")
    tour_id = fields.Many2one("knowsystem.tour", string="Tour", ondelete="cascade")
