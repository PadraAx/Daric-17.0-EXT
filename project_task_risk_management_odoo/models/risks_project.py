...
class Risks(models.Model):
    ...
    category_id = fields.Many2one(
        "risk.category", string="Category", help="Select Category", tracking=True
    )
    risk_type = fields.Many2one(
        "risk.type", string="Risk Type", tracking=True, help="Risk Type"
    )
    risk_response = fields.Many2one(
        "risk.response", string="Risk Response", help="Risk response", tracking=True
    )
