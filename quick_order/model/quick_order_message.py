...
class QuickOrderMessage(models.Model):
    ...
    def create(self, vals):
        ...
        for record in records:
            if record.website_id.id == vals.get('website_id'):
                raise ValidationError(_('Another record already exist for this website!!!'))
        return super(QuickOrderMessage, self).create(vals)
