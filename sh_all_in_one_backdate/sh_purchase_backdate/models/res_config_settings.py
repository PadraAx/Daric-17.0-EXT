...
class ResCompany(models.Model):
    ...
    sh_po_backdate_for_stock_move = fields.Boolean("Receipts has Same Backdate ")
...
class ResConfigSettings(models.TransientModel):
    ...
    sh_po_backdate_for_stock_move = fields.Boolean(
        "Receipts has Same Backdate ", related="company_id.sh_po_backdate_for_stock_move", readonly=False)
